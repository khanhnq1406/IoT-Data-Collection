...
#define IO_USERNAME "khanhnq1406"
#define IO_KEY "aio_SLVp61QtyK1ZmJJuDUM7Cn8SB2cb"
...
#define WIFI_SSID wifiConfig.boardingSsid
#define WIFI_PASS wifiConfig.boardingPassword
