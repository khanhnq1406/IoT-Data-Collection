...
void readData()
{
  Serial.println("Start Read data");
    ResponseStructContainer rsc = e32ttl.receiveMessage(sizeof(Node1Recv));
    node1Recv = *(Node1Recv*) rsc.data;
    Serial.print("node1Recv.motorStatus = "); Serial.println(node1Recv.motorStatus);
    rsc.close();
}